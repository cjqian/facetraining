...
# # python noise.py data/lfw_inner_aligned speckle lfw_inner_aligned_speckle1000 1.00 
# # # now=$(date +"%T")
...
# python eval.py features/lfw_inner_linear_features/classifier.pkl data/lfw_inner_aligned lfw_inner_aligned_speckle1000 lfw_inner_linear_speckle100.out linear 
...
python eval.py features/lfw_inner_linear_features/classifier.pkl data/lfw_inner_aligned lfw_inner_aligned_gauss16 lfw_inner_linear_gauss16.out linear 
...
# python eval.py features/lfw_inner_gmm_features/classifier.pkl data/lfw_inner_aligned lfw_inner_aligned_gauss16 lfw_inner_gmm_gauss16.out gmm 
...
# # # # radial
python eval.py features/lfw_inner_radial_features/classifier.pkl data/lfw_inner_aligned lfw_inner_aligned_gauss16 lfw_inner_radial_gauss16.out radial 
...
# # # # gaussian
python eval.py features/lfw_inner_gaussian_features/classifier.pkl data/lfw_inner_aligned lfw_inner_aligned_gauss16 lfw_inner_gaussian_gauss16.out gaussian 
...
# # # # decision tree
python eval.py features/lfw_inner_decisiontree_features/classifier.pkl data/lfw_inner_aligned lfw_inner_aligned_gauss16 lfw_inner_decisiontree_gauss16.out decisiontree 
...
# # # # dbn
python eval.py features/lfw_inner_dbn_features/classifier.pkl data/lfw_inner_aligned lfw_inner_aligned_gauss16 lfw_inner_dbn_gauss16.out dbn 
